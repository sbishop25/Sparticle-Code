...
#include "SampleAnalyzer/User/Analyzer/pTAnalysis.h"
#include <TFile.h>
#include <TH1F.h>
using namespace MA5;
using namespace std;
...
// -----------------------------------------------------------------------------
bool pTAnalysis::Initialize(const MA5::Configuration& cfg, const std::map<std::string,std::string>& parameters)
{
...
// -----------------------------------------------------------------------------
void pTAnalysis::Finalize(const SampleFormat& summary,
...
// -----------------------------------------------------------------------------
bool pTAnalysis::Execute(SampleFormat& sample, const EventFormat& event)
{
  // Event weight
  MAdouble64 myWeight;
