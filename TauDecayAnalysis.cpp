...
//Similar to LeptonAnalysis in terms of code removed from original document. Instead of identifying numbers of electrons, muons, used to see
//direct path tau particle decayed
// -----------------------------------------------------------------------------
// Initialize
...
*/
//TAUS - copied muon code currently, change when able
...
//DETERMINE WHICH TAU DECAY PROCESSES OCCURRED
//use GetDecayMode
MAuint32 numEDecay = 0;
MAuint32 numMDecay = 0;

for (MAuint32 t = 0; t < SignalTaus.size(); t++) {
  if()
}
